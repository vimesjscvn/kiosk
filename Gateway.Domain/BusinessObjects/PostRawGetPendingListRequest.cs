...
namespace TEK.Gateway.Domain.BusinessObjects
{
    ...
    public class GetRawPendingListData
    {
        ...
        [JsonProperty("waiting_patient")]
        public List<GetRawPendingListPatientData> WaitingPatient { get; set; }

        [JsonProperty("missing_patient")]
        public List<GetRawPendingListPatientData> MissingPatient { get; set; }
    }
