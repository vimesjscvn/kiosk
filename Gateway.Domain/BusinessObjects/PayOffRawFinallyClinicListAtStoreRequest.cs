...
namespace TEK.Gateway.Domain.BusinessObjects
{
    ...
    public class PayOffRawFinallyClinicListAtStoreRequest
    {
        ...
        [JsonProperty("book_no_cancel")]
        public string BookNoCancel { get; set; }

        [JsonProperty("serial_no_cancel")]
        public string SerialNoCancel { get; set; }

        [JsonProperty("recv_no_cancel")]
        public int RecvNoCancel { get; set; }
