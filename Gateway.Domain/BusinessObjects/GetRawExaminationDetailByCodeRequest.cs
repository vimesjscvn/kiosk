...
namespace TEK.Gateway.Domain.BusinessObjects
{
    ...
    public class GetRawExaminationDetailByCodePrescriptionData
    {
        ...
        public List<GetRawExaminationDetailByCodeMedicineDetailData> Medicines { get; set; }
    ...
    public class GetRawExaminationDetailByCodeExaminationData
    {
        ...
        [JsonProperty("clinical_examination")]
        public string ClinicalExamination { get; set; }

        [JsonProperty("full_body_part")]
    ...
    public class GetRawExaminationDetailByCodeSubTestResultData
    {
        ...
        [JsonProperty("normal_range1")]
        public string NormalRange1 { get; set; }

        [JsonProperty("normal_range2")]
        public string NormalRange2 { get; set; }

        [JsonProperty("unit")]
        public string Unit { get; set; }

        [JsonProperty("file_attach")]
        public string FileAttach { get; set; }

        [JsonProperty("file_attach_name")]
    ...
    {
        [JsonProperty("result")]
        public GetRawExaminationDetailByCodeData Result { get; set; }
    }
}
