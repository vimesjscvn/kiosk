...
namespace TEK.Gateway.Domain.BusinessObjects
{
    ...
    /// 
    /// </summary>
    public class PostRawFinallyClinicRequest
    {
        /// <summary>
    ...
    public class PostRawFinallyClinicRegistrationResponse : BaseRawResponse
    {
        /// <summary>
    ...
    /// </summary>
    public class PostRawFinallyClinicRegistrationResponseData
    {
        /// <summary>
