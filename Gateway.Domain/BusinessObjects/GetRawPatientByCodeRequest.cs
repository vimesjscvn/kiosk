...
namespace TEK.Gateway.Domain.BusinessObjects
{
    ...
    /// 
    /// </summary>
    public class GetRawPatientByCodeRequest : BaseRawRequest
    {
    }
    ...
    /// 
    /// </summary>
    public class GetRawPatientByCodeResponse : BaseRawResponse
    {
        /// <summary>
        ...
        public GetRawPatientByCodeData PatientInfo { get; set; }
    }

    /// <summary>
    /// Class FindByPatientCodeExternalData.
    /// </summary>
    public class GetRawPatientByCodeData
    {
        /// <summary>
