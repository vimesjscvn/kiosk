...
namespace Admin.API.Domain.Services
{
    ...
    /// 
    /// </summary>
    /// <seealso cref="TEK.Core.Service.Interfaces.IRegisterService" />
    public class RegisterInPatientService : IRegisterService
    {
        /// <summary>
        /// The unit of work
        /// </summary>
        ...
        public RegisterInPatientService(IUnitOfWork unitOfWork,
        ...
        /// </exception>
        public async Task RegisterListServiceInPatient(RegisterListServiceRequest request)
        {
            if (!DateTimeUtils.CheckValidDatetime(request.RegisteredDate))
            {
                throw new Exception(MessagesCode.InvalidFormatDatetime);
