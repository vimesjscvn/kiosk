...
namespace CS.Common.Helpers
{
    ...
    public static class HealthcareHelper
    {
        ...
        public static PatientType GetPatientType(string cardNumber, DateTime? birthday)
        {
            ...
            if (birthday.HasValue && DateTime.Now.Year - birthday.Value.Year <= MINAGE) result = PatientType.Priority6;

            if (birthday.HasValue && DateTime.Now.Year - birthday.Value.Year >= MAXAGE) result = PatientType.Priority80;
        ...
        /// <param name="type">The type.</param>
        /// <returns>PatientType.</returns>
        public static PatientType GetPatientTypeWithExternalCode(string cardNumber, DateTime? birthday,
            string type = "")
        {
            PatientType patientType;
            switch (type)
        ...
        {
            var name = PatientTypeConstants.Normal;
            switch (patientType)
            {
