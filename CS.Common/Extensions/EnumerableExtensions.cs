...
namespace CS.Common.Extensions
{
    public static class EnumerableExtensions
    {
        ...
        public static IEnumerable<T> RefineWithFallback<T>(this IEnumerable<T> source, Func<T, bool> filter,
            Func<T, bool> altFilter)
        {
        ...
        public static HashSet<TElement> ToHashSet<TSource, TElement>(this IEnumerable<TSource> source,
            Func<TSource, TElement> elementSelector, IEqualityComparer<TElement> comparer = null)
        {
            if (source == null)
        ...
        public static IEnumerable<TSource> ConditionalWhere<TSource>(this IEnumerable<TSource> source, bool condition,
        ...
        public static IEnumerable<TSource> MaybeOrderBy<TSource, TKey>(this IEnumerable<TSource> source, bool condition,
        ...
        public static IEnumerable<TSource> UnionIf<TSource>(this IEnumerable<TSource> source, bool condition,
            IEnumerable<TSource> unionSet)
        {
            return condition ? source.Union(unionSet) : source;
        }

        public static IEnumerable<TSource> UnionIf<TSource>(this IEnumerable<TSource> source, bool condition,
            Lazy<IEnumerable<TSource>> unionSet)
        {
        ...
        {
            return "({0})".FormatWith(source
                .Aggregate(string.Empty, (current, id) => current + "{0}:\"{1}\" OR ".FormatWith(fieldName, id))
                .TrimEnd(' ', 'O', 'R'));
        }
        ...
        public static string StringConcat<T>(this IEnumerable<T> source, Func<T, string> toString,
            Func<T, string> toStringLast = null, Func<T, string> toStringFirst = null)
        {
        ...
        /// </param>
        /// <returns></returns>
        public static string StringConcat(this IEnumerable<string> source, string delimiter, bool trimEnd = true,
        ...
        public static Dictionary<TK, TV> FilterDict<TK, TV>(this Dictionary<TK, TV> dict,
            Func<KeyValuePair<TK, TV>, bool> where)
        {
