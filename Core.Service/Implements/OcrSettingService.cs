...
namespace Core.Service.Implements
{
    public class OcrSettingService : IOcrSettingService
    {
        ...
        public async Task<TableResultJsonResponse<OcrSettingViewModel>> GetAll(GetOcrSettingRequest request)
        {
            ...
            var data = new List<OcrSettingViewModel>();
            ...
            var ocrSettings = _unitOfWork.GetRepository<OcrSetting>().GetAll().Where(predicate)
        ...
        public async Task<List<OcrSettingViewModel>> Export(ExportOcrSettingRequest request)
        {
            ...
            var ocrSettings = await _unitOfWork.GetRepository<OcrSetting>().GetAll().Where(predicate)
        ...
        {
            var settingModels = new OcrSettingValue
            {
