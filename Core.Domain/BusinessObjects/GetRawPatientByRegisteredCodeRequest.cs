...
namespace Core.Domain.BusinessObjects
{
    /// <summary>
    /// </summary>
    public class GetRawPatientByRegisteredCodeRequest : BaseRawRequest
    {
    ...
    /// <summary>
    /// </summary>
    public class GetRawPatientByRegisteredCodeResponse : BaseRawResponse
    {
        /// <summary>
        ...
        public GetRawPatientByRegisteredCodeData PatientByRegisteredCodeInfo { get; set; }
    }

    /// <summary>
    ///     Class FindByPatientByRegisteredCodeCodeExternalData.
    /// </summary>
    public class GetRawPatientByRegisteredCodeData
    {
        /// <summary>
