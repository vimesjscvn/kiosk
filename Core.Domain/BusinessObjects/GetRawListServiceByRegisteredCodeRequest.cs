...
namespace Core.Domain.BusinessObjects
{
    ...
    {
        [JsonProperty("result")] public GetRawListServiceByRegisteredCodeData Result { get; set; }
    }
    ...
    public class GetRawListOrderByRegisteredCodeData
    {
        ...
        [JsonProperty("department_type")] public int DepartmentType { get; set; }
        ...
        [JsonProperty("group_service_name")] public string GroupServiceName { get; set; }
        ...
        [JsonProperty("examination_code")] public string ExaminationCode { get; set; }

        [JsonProperty("examination_name")] public string ExaminationName { get; set; }
    }
    ...
    public class GetRawListServiceByRegisteredCodeData
    {
        ...
        [JsonProperty("patient_type_id")] public string PatientTypeId { get; set; }

        [JsonProperty("patient_type")] public string PatientType { get; set; }

        [JsonProperty("orders")] public List<GetRawListOrderByRegisteredCodeData> Orders { get; set; }
    }
}