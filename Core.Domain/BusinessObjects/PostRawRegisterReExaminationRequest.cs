...
namespace Core.Domain.BusinessObjects
{
    ...
    public class PostRawRegisterReExaminationRequest
    {
        ...
        [JsonProperty("departments")] public List<PostRawRegisterReExaminationDataRequest> Departments { get; set; }
    }
    ...
    {
        [JsonProperty("result")] public List<PostRawRegisterReExaminationResponseData> Result { get; set; }
    }
}