...
namespace Core.Domain.BusinessObjects
{
    ...
    public class PostRawRegisterExaminationRequest
    {
        ...
        [JsonProperty("departments")] public List<PostRawRegisterExaminationDataRequest> Departments { get; set; }
    }
    ...
    public class PostRawRegisterExaminationResponseData
    {
        ...
        [JsonProperty("qr_code")] public string QRCode { get; set; }
    }

    public class PostRawRegisterExaminationResponse : BaseRawResponse
    {
        [JsonProperty("result")] public List<PostRawRegisterExaminationResponseData> Result { get; set; }
    }
}