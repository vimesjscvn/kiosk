...
namespace Core.Domain.BusinessObjects
{
    ...
    {
        [JsonProperty("Result")] public List<GetRawListGroupDeptData> Result { get; set; }
    }

    public class GetRawListDepartmentData
    {
        [JsonProperty("department_code")] public int DepartmentCode { get; set; }
    ...
    public class GetRawListGroupDeptData
    {
        ...
        [JsonProperty("group_dept_type")] public string GroupDeptType { get; set; }

        [JsonProperty("group_dept_address")] public string GroupDeptAddress { get; set; }

        [JsonProperty("departments")] public List<GetRawListDepartmentData> Departments { get; set; }
    }
}